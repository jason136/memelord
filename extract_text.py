...
def main():
    ...
    for _, dirs, _ in os.walk(memes_path):
        for dir in dirs:
            dicts[dir] = pd.read_csv(f'{memes_path}/{dir}/{dir}.csv', usecols=globals.keys).to_dict(orient='list')
    ...
    filename = f'{globals.data_path}/extracted_text.txt'
    lines = []
